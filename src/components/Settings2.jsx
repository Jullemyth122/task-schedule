...
const Settings = () => {
    ...
    const handleLanguageChange = (e) => {
        ...
        i18n.changeLanguage(newLang); // This will update the language globally
        // Also, save the new language preference in Firestore if needed
    };
        ...
        <main className="settings-content">
            ...
            <section className="connections-section">
                ...
                <p className="info-note">
                    To manage connected accounts, please use the social login options on the
                    sign-in page.
                </p>
            </section>
            )}
